...
// Get info admins
$admin_name = "" ;
 $sql = "SELECT * from admin_tb where a_username = '$username'";
						$result = mysqli_query($conn, $sql) or die("Query Failed.");
                           if(mysqli_num_rows($result) > 0){
...
$_SESSION["count_student"]=$count_student;
  ...
  <ul class="navbar-nav align-items-center right-nav-link">
    ...
    <li class="nav-item">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
        <span class="user-profile"><img src="assets\images\profile_img\<?php echo"admin_profile.png";?>" class="img-circle" alt="user avatar"></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="assets\images\profile_img\admin_profile.png" > </div>
...
<div class="clearfix"></div>
  ...
  <!--Start Dashboard Content-->
        ...
        <div class="row row-group m-0">
                ...
                <div class="card-body">
                  <h5 class="text-white mb-0"><?php echo"$count_student";?> <span class="float-right"><i class="zmdi zmdi-accounts"></i></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:100%"></div> <!-- Formula for progress bar -->
                    </div>
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">Total Files</p>
                </div>
            </div>
        </div>
    </div>
	...
	<!--End Row-->
				 ...
				 <div class="card">
				   <div class="card-body">
				   <div class="card-title"><h1>Welcome,<br> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Admin </div>
              ...
              $result = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                     ...
                     ?>
                          <tr>
                            ...
                            <a href='assets\images\notices\<?=$notice_img_link?>' target="_blank" > <i>View Notice</i> &nbsp&nbsp&nbsp&nbsp</a>
							<?php no_img: ?>
