  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <!--Start Dashboard Content-->
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Delete Curriculum</h5>
        ...
        <table class="table">
            ...
            <th scope="col"><center>File</th>
            <th scope="col"><center>Date & Time</th>
            <th scope="col"><center>Operation</th>
               ...
               $sql_c = "select * from curriculam_tb where flag != 1 ORDER BY id DESC ";
       
                    $count = 1;
                      
                      $result_c = mysqli_query($conn, $sql_c) or  die(mysqli_error($conn));
                      while($row = mysqli_fetch_assoc($result_c)) {
                        echo "<tr><td> <center>".$count." </td><td><center>".$row['name']
                        ." </td><td><center>".$row['link']
                        ." </td><td><center>".$row['date']
                        
                        ." </td><td><center>"."<form action = 'teacher_dept_curriculum_delete_db.php' method = 'POST' target=''>
