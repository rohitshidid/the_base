...
<body class="bodycolor">
    ...
    <div class="row">
        ...
        <div class="jumbotron container div_height col-md-2" style="margin-left: 6%;">
            <center>
        ...
        <div class="jumbotron container div_height col-md-2" style="margin-left: 6%;">
            <center>
                <br>
                <a href="quizname.php"><input type="button" class="btn btn-outline-secondary" value="Create Quiz" style="font-size:20px"></a>
            </center>
    ...
    <center>
        <div class="row">
            <div class="container jumbotron div_height col-md-2" style="margin-left: 22%;">
                ...
                <center>
                    ...
                    ?>
                    <br><br>
                    <input type="submit" name="activate" value="Activate Quiz" style="font-size:17px" class="btn btn-outline-secondary">
                </center>
                </form>
            </div>
            ...
            <div class="container jumbotron div_height col-md-2"  style="margin-left: 22%;">
                ...
                <center>
                    <br><br>
                    <input type="submit" name="activate" value="Deactivate All Quiz" style="font-size:17px" class="btn btn-outline-secondary">
                </center>
                </form>
            </div>
