<html>
    ...
    <body>
        <?php 
			...
			FROM student_tb 
			where (rollno like '%$keyword%' or caste like '%$keyword%' or first_name like '%$keyword%'or last_name like '%$keyword%') and flag = 1 order by rollno asc ");
...
<?php while($row = mysqli_fetch_assoc($res)){
    ...
    ?>
                    ...
                    <tr>
		                ...
		                <td><?php echo $row['sem1_marks']; ?></td>
		                <td><?php echo $row['sem2_marks']; ?></td>
		                <td><?php echo $row['sem3_marks']; ?></td>
		                <td><?php echo $row['sem4_marks']; ?></td>
		                <td><?php echo $row['sem5_marks']; ?></td>
