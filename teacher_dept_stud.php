...
<header class="topbar-nav">
 <nav class="navbar navbar-expand fixed-top">
   <ul class="navbar-nav mr-auto align-items-center">
    ...
    <li class="nav-item">
      <form class="search-bar" action="teacher_dept_stud_search.php" method ="POST" >
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
						...
						<th scope="col"><center>Latest Percentage</th>
				...
				// display all info
						 ...
						 if ($keyword == ""){
							 $sql = "select * from student_tb where student_tb.flag = 1	";
						 }else{
