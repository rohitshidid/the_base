...
<div class="clearfix"></div>
  ...
  <!--Start Dashboard Content-->
	...
	<?php 
	  ...
	  $first_2_number = substr($rollno_session,0,2);
	  $first_4_number = substr($rollno_session,0,4);
	...
	<br>
	 <div class="tab-pane" id="messages">
          ...
          $sql = "select * from notice_tb where student_no like '$first_2_number' order by end_date asc";
      ...
      <!-- for first 4 digits -->
          ...
          $sql = "select * from notice_tb where student_no like '$first_4_number' order by end_date asc";
              ...
              $result = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                     ...
                     ?>
                          <tr>
							...
							<?php if($notice_img_link == ""){ goto no_img2;} ?>
                            <a href='assets\images\notices\<?=$notice_img_link?>' target="_blank" >View Notice &nbsp&nbsp&nbsp&nbsp</a>
							<?php no_img2: ?>
          ...
          $sql = "select * from notice_tb where student_no like '$rollno_session' order by end_date asc";
              ...
              $result = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                     ...
                     ?>
                          <tr>
							...
							<?php if($notice_img_link == ""){ goto no_img3;} ?>
                            <a href='assets\images\notices\<?=$notice_img_link?>' target="_blank" >View Notice &nbsp&nbsp&nbsp&nbsp</a>
							<?php no_img3: ?>
          ...
          $sql = "select * from notice_tb where student_no like '' order by end_date asc";
              ...
              $result = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                     ...
                     ?>
                          <tr>
							...
							<?php if($notice_img_link == ""){ goto no_img4;} ?>
                            <a href='assets\images\notices\<?=$notice_img_link?>' target="_blank" >View Notice &nbsp&nbsp&nbsp&nbsp</a>
							<?php no_img4: ?>
