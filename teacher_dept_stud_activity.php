				...
				// display all info
						 ...
						 if ($keyword == ""){
							 $sql = "select * from activity_tb";
							  ...
							  $sql = "select * from activity_tb where (roll_no like '%$keyword%' or event_name like '%$keyword%'  or name like '%$keyword%' or event_venue like '%$keyword%' or start_date like '%$keyword%' or end_date like '%$keyword%') order by start_date asc ";
						 }
